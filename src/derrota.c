...
GtkWidget* crearPantallaDerrota(void) {
    ...
    GtkWidget *label_felicidades = gtk_label_new("¡Has sido derrotado!");
    ...
    GtkWidget *label_mensaje = gtk_label_new("Mejor suerte la próxima vez");
    ...
    GtkWidget *label_puntaje = gtk_label_new("PUNTAJE OBTENIDO");
